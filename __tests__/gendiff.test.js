...
const outputFirstCaseJsonFormat = fs.readFileSync('./__tests__/fixtures/case-1/json-diff.json', {encoding: 'utf8', flag: 'r'});
const outputFirstCasePlainFormat = fs.readFileSync('./__tests__/fixtures/case-1/plain-diff.txt', {encoding: 'utf8', flag: 'r'});
const outputFirstCaseStylishFormat = fs.readFileSync('./__tests__/fixtures/case-1/stylish-diff.txt', {encoding: 'utf8', flag: 'r'});

const outputSecondCaseJsonFormat = fs.readFileSync('./__tests__/fixtures/case-2/json-diff.json', {encoding: 'utf8', flag: 'r'});
const outputSecondCasePlainFormat = fs.readFileSync('./__tests__/fixtures/case-2/plain-diff.txt', {encoding: 'utf8', flag: 'r'});
const outputSecondCaseStylishFormat = fs.readFileSync('./__tests__/fixtures/case-2/stylish-diff.txt', {encoding: 'utf8', flag: 'r'});
